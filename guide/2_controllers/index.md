...
The framework provides an `api` renderer to accomplish this. This calls the `render_api` method to
do the actual work (which was called `api_response` prior to v1, and it is still aliased for
